    ...
    <div className="bg-slate-50 min-h-screen pb-12">
      ...
      <div className="relative bg-white border-b border-slate-200 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
           {/* Top Right Blob */}
           <svg viewBox="0 0 200 200" className="absolute -top-32 -right-16 w-80 h-80 text-brand/5" fill="currentColor">
           ...
           {/* Floating Paw Left */}
           <svg viewBox="0 0 100 100" fill="currentColor" className="absolute top-10 left-[15%] w-16 h-16 text-brand/10 transform -rotate-6">
           ...
           {/* Floating Paw Right */}
           <svg viewBox="0 0 100 100" fill="currentColor" className="absolute bottom-4 right-[25%] w-10 h-10 text-brand/10 transform rotate-12">
             <circle cx="25" cy="30" r="9" />
             <circle cx="43" cy="18" r="10" />
             <circle cx="63" cy="18" r="10" />
             <circle cx="81" cy="32" r="9" />
