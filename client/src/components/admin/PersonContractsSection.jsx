...
function PersonContractsSection({ signerEmail, title = 'Executed Agreements' }) {
  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      {loading ? (
        ...
        <p className="mt-4 text-sm text-slate-500">No agreements on file for this person yet.</p>
      ) : (
