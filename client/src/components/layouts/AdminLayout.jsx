...
const navItems = [
  ...
  { label: 'Onboarding', icon: UserCheck, path: '/admin/onboarding', permission: 'onboarding.view' },
  { label: 'Contracts', icon: FileSignature, path: '/admin/contracts', permission: 'contracts.view' },
  { label: 'Calendar', icon: Calendar, path: '/admin/calendar', permission: 'events.view' },
  { label: 'Marketing', icon: Megaphone, path: '/admin/marketing', permission: 'events.view' },
...
const pageMeta = [
  ...
  { match: (p) => p.startsWith('/admin/marketing'), title: 'Marketing', subtitle: 'Schedule social posts. AI captions live on each kitten’s Publishing & Social tab.' },
