...
function PublicLayout() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-slate-700">
      ...
      <footer className="border-t border-brand-dark/10 bg-brand text-white">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 py-6 sm:flex-row lg:px-8">
          ...
          <div className="flex items-center gap-5">
            {settings.facebookUrl ? (
              <a href={settings.facebookUrl} target="_blank" rel="noreferrer" className="text-white/90 transition-colors hover:text-white" aria-label="Facebook">
            ...
            {settings.instagramUrl ? (
              <a href={settings.instagramUrl} target="_blank" rel="noreferrer" className="text-white/90 transition-colors hover:text-white" aria-label="Instagram">
            ...
            <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="text-white/90 transition-colors hover:text-white" aria-label="TikTok">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="mailto:hello@pawsitivetransformations.org" className="text-white/90 transition-colors hover:text-white" aria-label="Email">
              <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
