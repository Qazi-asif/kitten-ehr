  ...
  return (
    <div className="flex items-center gap-4">
      {settings.facebookUrl ? (
        <a href={settings.facebookUrl} target="_blank" rel="noreferrer" className="text-gray-400 transition-colors hover:text-white" aria-label="Facebook">
      ...
      {settings.instagramUrl ? (
        <a href={settings.instagramUrl} target="_blank" rel="noreferrer" className="text-gray-400 transition-colors hover:text-white" aria-label="Instagram">
      ...
      <a href="https://tiktok.com" target="_blank" rel="noreferrer" className="text-gray-400 transition-colors hover:text-white" aria-label="TikTok">
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <a href="mailto:hello@pawsitivetransformations.org" className="text-gray-400 transition-colors hover:text-white" aria-label="Email">
        <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className="flex min-h-screen flex-col bg-white text-slate-700">
      ...
      <footer className="bg-gray-900 text-gray-300">
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
          <div className="mb-10 flex flex-col items-start justify-between gap-6 border-b border-gray-800 pb-10 sm:flex-row sm:items-center">
            <div>
              <p className="text-lg font-semibold text-white">{orgName}</p>
              <p className="mt-1 text-sm text-gray-400">Cat Rescue &amp; Human Wellness</p>
            </div>
        ...
        <div className="border-t border-gray-800 bg-gray-900/80 px-6 py-4 lg:px-8">
          <div className="mx-auto max-w-7xl space-y-2 text-center text-xs text-gray-500">
            ...
            <p>
              <Link to="/privacy" className="text-gray-400 underline-offset-2 transition-colors hover:text-gray-300 hover:underline">
                Privacy Policy
              </Link>
              {' · '}
              <span>
                ...
                <Link
                  ...
                  className="text-gray-400 underline-offset-2 transition-colors hover:text-gray-300 hover:underline"
                >
        ...
        {/* Row 3 — Agency credit */}
        <div className="border-t border-gray-800 px-6 py-3 lg:px-8">
          <p className="mx-auto max-w-7xl text-right text-[11px] text-gray-600">
            <span className="transition-colors hover:text-gray-500">Engineered by Wolke Consultancy LLC</span>
          </p>
        </div>
      </footer>
    </div>
